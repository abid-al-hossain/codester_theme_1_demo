(function () {
  ...
  try {
    ...
    if (prefs.hasCustomColors && prefs.colors) {
      ...
      var bg = tuneBackgroundTone(rawBg, rawPrimary, dark, { darkMin: 20, darkMax: 30, lightMin: 94, lightMax: 98 })
      var bg2 = tuneBackgroundTone(normalizeHex(colors.bg2, DEFAULTS.bg2), rawPrimary, dark, { darkMin: 24, darkMax: 30, lightMin: 90, lightMax: 96 })
      var surface = tuneBackgroundTone(normalizeHex(colors.surface, bg2), rawPrimary, dark, { darkMin: 26, darkMax: 30, lightMin: 92, lightMax: 98 })
      var primary = improveContrastAcross(softenExtremeAccent(improveContrastAcross(rawPrimary, [bg, bg2, surface], 4.5), bg, dark), [bg, bg2, surface], 4.5)
      var secondary = improveContrastAcross(softenExtremeAccent(improveContrastAcross(normalizeHex(colors.secondary, DEFAULTS.secondary), [bg, bg2, surface], 3.5), bg, dark), [bg, bg2, surface], 3.5)
      var accent = improveContrastAcross(softenExtremeAccent(improveContrastAcross(normalizeHex(colors.accent, DEFAULTS.accent), [bg, bg2, surface], 3.5), bg, dark), [bg, bg2, surface], 3.5)
